...
exports.DATABASE_URL = process.env.DATABASE_URL || "localhost:8080/tennis-ladder-app";
exports.TEST_DATABASE_URL = process.env.TEST_DATABASE_URL || "localhost:8080/test-tennis-ladder-app";
